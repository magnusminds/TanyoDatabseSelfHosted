...
-- Description: Get count of Orders which are in Delivered status
-- =============================================
/*
--Admin
EXEC Dashboard_GetDeliveredOrderCount
 @TenantId = 2,
 @CurrentUserId = 4328,
...
*/
CREATE   PROCEDURE [dbo].[Dashboard_GetDeliveredOrderCount]
    @TenantId INT,
    @CurrentUserId INT,
    @RoleId NVARCHAR(100)
WITH ENCRYPTION
