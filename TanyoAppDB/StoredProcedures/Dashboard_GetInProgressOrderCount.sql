...
-- Description: Get count of Orders which are in InProgress status
-- =============================================
/*
--Admin
EXEC Dashboard_GetInProgressOrderCount
 @TenantId = 2,
 @CurrentUserId = 4328,
...
*/
CREATE   PROCEDURE [dbo].[Dashboard_GetInProgressOrderCount]
    @TenantId INT,
    @CurrentUserId INT,
    @RoleId NVARCHAR(100)
WITH ENCRYPTION
