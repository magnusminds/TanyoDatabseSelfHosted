...
-- Description: Get count of Orders which are in PendingApproval status
-- =============================================
/*
--Admin
EXEC Dashboard_GetOrderPendingApprovalCount
 @TenantId = 2,
 @CurrentUserId = 4328,
...
*/
CREATE   PROCEDURE [dbo].[Dashboard_GetOrderPendingApprovalCount]
    @TenantId INT,
    @CurrentUserId INT,
    @RoleId NVARCHAR(100)
WITH ENCRYPTIONAS
BEGIN
    ...
    DECLARE 
        ...
        @IsWholesaler BIT = 0,
        @OrderStatus INT = 1; -- PendingForApproval = 1
