-- =============================================
-- Author:  MagnusMinds
-- Create date: 23-Jul-2025
-- Description: Get all Inwards from dashboard
-- =============================================
/*
--Admin
EXEC App_List_GetAllInwards
 @TenantId = 2
...
EXEC App_List_GetAllInwards
 @TenantId = 2
*/ 
CREATE   PROCEDURE [dbo].[App_List_GetAllInwards]
    @TenantId INT,
...
BEGIN
    ...
    ;WITH InwardCTE AS (
        ...
        FROM InwardEntry i
        LEFT JOIN Vendors v ON i.VendorId = v.VendorId AND v.TenantId = @TenantId
        LEFT JOIN AspNetUsers crt ON i.CreatedBy = crt.UserId
        LEFT JOIN AspNetUsers upd ON i.UpdatedBy = upd.UserId
        WHERE
            i.TenantId = @TenantId
			AND i.IsDeleted = 0
