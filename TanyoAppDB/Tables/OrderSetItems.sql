CREATE TABLE [dbo].[OrderSetItems] (
    ...
    [CostPrice]              NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF__OrderSetI__CostP__3BEAD8AC] DEFAULT ((0)) NOT NULL,
    [UnitPrice]              NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NOT NULL,
    [DiscountPrice]          NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NOT NULL,
    [UnitSalePrice]          NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF_OrderSetItems_UnitSalePrice] DEFAULT ((0.00)) NULL,
    [Discount]               NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF_OrderSetItems_Discount] DEFAULT ((0)) NOT NULL,
    [AmountBeforeGST]        DECIMAL (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [df_OrderSetItems_AmountBeforeGST] DEFAULT ((0)) NULL,
    [CGSTAmount]             DECIMAL (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [df_OrderSetItems_CGSTAmount] DEFAULT ((0)) NULL,
    [SGSTAmount]             DECIMAL (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [df_OrderSetItems_SGSTAmount] DEFAULT ((0)) NULL,
    [GST]                    NUMERIC (18, 2)                                      CONSTRAINT [DF__OrderSetIte__GST__3AF6B473] DEFAULT ((18)) NOT NULL,
    [TotalAmount]            NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NOT NULL,
    [GrossTotal]             NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF_OrderSetItems_GrossTotal] DEFAULT ((0)) NOT NULL,
    ...
    [InstantCostPrice]       NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NULL,
    [InstantUnitPrice]       NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NULL,
