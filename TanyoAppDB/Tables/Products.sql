CREATE TABLE [dbo].[Products] (
    ...
    [RetailerPrice]          NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF__Products__Retail__0ECE1972] DEFAULT ((0.00)) NOT NULL,
    [WholesalerPrice]        NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF__Products__Wholes__0FC23DAB] DEFAULT ((0.00)) NOT NULL,
    [RetailOfferPrice]       NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NULL,
    ...
    [CostPrice]              NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [DF__Products__CostPr__6EC0713C] DEFAULT ((0)) NOT NULL,
    ...
    [WholesalerOfferPrice]   NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NULL,
