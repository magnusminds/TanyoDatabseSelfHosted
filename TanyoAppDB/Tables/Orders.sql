CREATE TABLE [dbo].[Orders] (
    ...
    [GrossTotal]                   NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NOT NULL,
    [Discount]                     NUMERIC (18, 2)                                      NOT NULL,
    [TotalAmount]                  NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') NOT NULL,
    [AmountBeforeGST]              NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [df_Orders_AmountBeforeGST] DEFAULT ((0)) NULL,
    [CGSTAmount]                   NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [df_Orders_CGSTAmount] DEFAULT ((0)) NULL,
    [SGSTAmount]                   NUMERIC (18, 2) MASKED WITH (FUNCTION = 'default()') CONSTRAINT [df_Orders_SGSTAmount] DEFAULT ((0)) NULL,
    ...
    [SalesmanCommissionPer]        NUMERIC (5, 2) MASKED WITH (FUNCTION = 'default()')  NULL,
